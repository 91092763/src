...
public class DeepDive01ForLoops
{
  ...
  {
    Assert.assertEquals(Tortoise.getPenWidth(), Tortoise.getPenWidth());
  }
  @Test
  ...
  {
    Tortoise.turn(21.01);
    Assert.assertEquals(21.0, Tortoise.getAngle(), 21.0);
  }
  @Test
  public void theTortoiseTurns15Twice() throws Exception
  {
    Tortoise.turn(30);
    Tortoise.turn(.01);
    Assert.assertEquals(30.0, Tortoise.getAngle(), 30.0);
  }
  @Test
